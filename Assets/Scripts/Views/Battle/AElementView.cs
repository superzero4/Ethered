...
{
    [FormerlySerializedAs("_renderer")] [Header("View")] [SerializeField] protected Renderer _mainRenderer;
    [ReadOnly] [SerializeField] protected T _data;

    [ReadOnly] [SerializeField] protected InfoUI _ui;
